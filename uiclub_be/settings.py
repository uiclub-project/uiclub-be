"""
Django settings for uiclub_be project.
...
SECRET_KEY = 'django-insecure-=cx&)p55u2h19fg7@4l3@-$^wi)!vuc+1@78z4se8cb%lceu88'
...
WSGI_APPLICATION = 'uiclub_be.wsgi.application'
